...
<html lang="en">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        ...
                        <p id="logo" class="logo img-responsive">Restaurant</p>
                        <p id="logo" class="logo img-responsive">Management</p>
                        <p id="logo" class="logo img-responsive">System</p>
                    </a>
                </div>
    ...
    @endforeach
        ...
        <!--==  7. Afordable Pricing  ==-->
        <section id="menu-list" class="pricing">
            <div id="w">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2020 <a href="#">Our Resturant Management System Website.</a> Develope by <a href="https://github.com/saiedfoyez23/final-term-project">Laravel Final Term Project Group </a>
                            </p>
                        </div>
                    </div>
                </div>
